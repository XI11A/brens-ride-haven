      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Available Mon-Sat, 9am-8pm</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">123 Anna Salai, T. Nagar, Chennai, Tamil Nadu 600017</p>
                    <p className="text-gray-500 text-sm mt-1">Close to Panagal Park</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Pongal & Diwali: Closed</p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
              ...
              <a 
                href="https://wa.me/919876543210?text=I%20need%20assistance%20with%20car%20rental" 
                target="_blank"
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="subject" type="text" placeholder="Car Booking Inquiry" required />
              </div>
        ...
        <div className="mt-12 bg-white p-4 rounded-lg shadow-md">
          <div className="aspect-[16/9] w-full overflow-hidden rounded-lg">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3886.819262613323!2d80.24444021509523!3d13.05073211709245!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5267376340b2fb%3A0x679475595b87d4fb!2sT.%20Nagar%2C%20Chennai%2C%20Tamil%20Nadu!5e0!3m2!1sen!2sin!4v1656426766171!5m2!1sen!2sin" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
              allowFullScreen 
